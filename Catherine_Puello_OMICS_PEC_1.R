...
# Renombro la primera columna como 'Samples' y las demás columnas como 'Sample_' para mayor claridad
...
# como tengo miltitud de datos y cada metabolito puede tener valores muy diferentes,
# Creo una Función para aplicar la prueba de significancia adecuada

# https://www.physiotutors.com/es/wiki/type-1-error-rate-control/
# https://es.statisticseasily.com/glosario/%C2%BFQu%C3%A9-es-el-procedimiento-Benjamin-Hochberg%3F/
...
# visualización en un mapa de calor
...
cor_matrix[abs(cor_matrix) < 0.7] <- 0
...
summary(plsda_model)
plot(plsda_model, typeVc = "overview")
plot(plsda_model, typeVc = "x-loading")
